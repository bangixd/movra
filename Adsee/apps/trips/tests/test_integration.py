...
class FullFlowIntegrationTest(TestCase):
    ...
    def test_full_campaign_to_trip_flow(self):
        ...
        # ------------------------------
        brand_response = self.client_api.post('/v1/brands/', {
        ...
        # اینجا POST به /v1/campaigns/ بزن؛ در غیر این صورت مستقیم مدل را بساز)
        ...
        available_response = self.driver_api.get(
            f'/v1/trips/available-campaigns/?city_id={self.city.id}'
        )
        ...
        # ------------------------------
        trip_create_response = self.driver_api.post('/v1/trips/', {
        ...
        # ------------------------------
        start_response = self.driver_api.patch(f'/v1/trips/{trip_id}/start/')
        ...
        loc_resp1 = self.driver_api.post('/v1/geo/driver-locations/',
        ...
        loc_resp2 = self.driver_api.post('/v1/geo/driver-locations/',
        ...
        # ------------------------------
        complete_response = self.driver_api.patch(f'/v1/trips/{trip_id}/complete/')
        ...
        trip2_response = self.driver_api.post('/v1/trips/', {
            'campaign': self.campaign.id,
        ...
        self.driver_api.patch(f'/v1/trips/{trip2_id}/start/')
        trip3_response = self.driver_api.post('/v1/trips/', {
            'campaign': self.campaign.id,
