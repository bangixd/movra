...
class PaymentFlowTest(TestCase):
    ...
    def test_01_calculate_cost(self):
        print("\n📊 تست ۱: محاسبهٔ هزینه")
        response = self.api.get(f'/v1/campaigns/{self.campaign.id}/cost/')
    ...
    def test_02_request_payment(self, mock_send):
        ...
        response = self.api.post('/v1/campaigns/payments/request/', {
    ...
    def test_03_verify_successful(self, mock_verify):
        ...
        response = self.api.get('/v1/campaigns/payments/verify/?Authority=ABC123&Status=OK')
        print(f"   Status: {response.status_code}")
        print(f"   Response: {response.data}")
    ...
    def test_04_verify_failed(self, mock_verify):
        ...
        response = self.api.get('/v1/campaigns/payments/verify/?Authority=FAIL123&Status=OK')
        print(f"   Status: {response.status_code}")
        print(f"   Response: {response.data}")
    ...
    def test_05_user_cancelled(self):
        ...
        response = self.api.get('/v1/campaigns/payments/verify/?Authority=CANCEL123&Status=NOK')
        print(f"   Status: {response.status_code}")
        print(f"   Response: {response.data}")
